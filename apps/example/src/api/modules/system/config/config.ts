...
const configApi = {
  ...
  /** 系统参数详情 */
  get: (id: number) => request.get<ConfigInfo>('api/system/system/config/get', { params: { id } }),
  ...
  /** 更新系统参数 */
  update: (id: number, data: ConfigFormData) => request.put('api/system/system/config/update', data, { params: { id } }),
